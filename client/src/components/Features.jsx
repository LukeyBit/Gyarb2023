...
const Features = () => (
  <div>
    ...
    <div className='space-y-8 items-center'>
      <article className='flex flex-col-reverse md:flex-row gap-12 mx-7'>
        ...
        <img src={searchImg} alt="search-img" className='rounded md:w-[47vw]'/>
      </article>
      <article className='flex flex-col md:flex-row gap-12 mx-7'>
        <img src={discoverImg} alt="discover-img" className='rounded md:w-[47vw]'/>
        <div className='text-center pt-7'>
      ...
      <article className='flex flex-col-reverse md:flex-row gap-12 mx-7'>
        <div className='text-center pt-7'>
        <h3 className='text-2xl font-bold'>More than 2 million recipes</h3>
        <hr className='mx-auto h-px w-[30vw] my-1 bg-gray-300 border-0'/>
        ...
        <img src={recipeImg} alt="recipe-img" className='rounded md:w-[47vw]'/>
      </article>
    </div>
