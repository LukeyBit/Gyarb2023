    ...
    <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="max-w-screen-md mb-8 lg:mb-16">
            ...
            <p className="text-gray-500 sm:text-xl dark:text-gray-400">Here at MealMaster we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
          </div>
          <div className="space-y-8 md:grid grid-cols-1 md:gap-12 md:space-y-0">
            <div>
            ...
            <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Discover</h3>
              <p className="text-gray-500 dark:text-gray-400">Discover delicious new recipes and cooking inspiration with our Discover feature. Browse a selection of recipes curated just for you, based on your dietary preferences, ingredients on hand, and favorite cuisines. You can also explore new and trending recipes, as well as seasonal recipes. With our Discover feature, you'll never run out of meal ideas and you'll be able to expand your culinary skills.</p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
