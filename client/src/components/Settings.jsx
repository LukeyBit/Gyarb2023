    ...
    return (
        <div className='w-[35vw] mt-8'>
            ...
            <div>
                ...
                <form className='ml-8' autoComplete='off' onClick={handlePasswordSubmit}>
                    <div className='relative z-0 mt-2 ml-2 mb-6 group flex flex-row py-auto'>
                        <input type="password" name="password" id="password" className="block py-2.5 px-0 text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-primary peer" placeholder=" " />
                    ...
                    <div className='relative z-0 mt-2 ml-2 mb-6 group flex flex-row py-auto'>
                        <input type="password" name="check-password" id="check-password" className="block py-2.5 px-0 text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-primary peer" placeholder=" " />
                        <label htmlFor="check-password" className="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-primary peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Old password</label>
                        <BiPencil size={25} type='submit' className='text-gray-500 hover:cursor-pointer hover:text-primary self-center' />
                    </div>
                </form>
            </div>
