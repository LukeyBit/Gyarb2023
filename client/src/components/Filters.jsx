...
const Filters = () => {
  ...
  return (
    <>
      <button className='lg:hidden fixed bottom-8 left-8 bg-primary rounded-full p-1.5 text-white'
        onClick={toggleMenu}>
        <BiFilter className='w-8 h-8' />
      </button>
      <div className={`lg:mr-10 lg:w-80 lg:min-h-full lg:scroll-m-1 lg:flex top-0 bg-white drop-shadow-xl w-full ${!open ? 'hidden' : 'fixed top-0 left-0 w-full min-h-screen z-1000'}`}>
